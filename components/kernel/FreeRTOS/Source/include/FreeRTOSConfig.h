...
#if TASK_RUN_MONITOR
    extern volatile unsigned long ulHightFreqTimerTicks;
    #define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS()     (ulHightFreqTimerTicks = 0UL)
    #define portGET_RUN_TIME_COUNTER_VALUE()             (ulHightFreqTimerTicks)
#endif
